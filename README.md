<p align="center">
  <img src="ui/track_text_ink.svg" alt="" width="370">
</p>
...
ui/         streamlit
  ...
  track*.svg  the wordmark: the browser tab, the sidebar, and the .ico the
                Windows installer is built with (packaging/make_icon.py)
...
A competition folder is the jury's work and stays out of the repository. One
is in it: **`competitions/example/`**, a meeting that never happened, with a
fictional field of 140 riders generated by the script beside it. It is what to
open to see the console working without holding a real entry list — a few
hundred under-18s' names, dates of birth and licence numbers — and it is what
the tests run on. See `competitions/example/README.md`.
